  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="flex items-center space-x-1 bg-blue-500 text-white px-4 py-2 rounded-button hover:bg-blue-600 transition"
      >
